...
#   PPAASS_PROXY_LOG_DIR=logs      Override supervisor log/PID directory
...
LOG_DIR="${PPAASS_PROXY_LOG_DIR:-logs}"
...
IDENTITY_PUBLIC_KEY="${PPAASS_PROXY_IDENTITY_PUBLIC_KEY:-data/proxy-identity-public.pem}"
