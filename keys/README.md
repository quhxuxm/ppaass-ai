...
Windows, and Android flow is to sign in through Proxy Web and let the Agent download its approved
...
Point Proxy at the private file and Proxy Web at the public file. User credentials are created and
approved through Proxy Web's SQLite-backed account flow. Never commit private PEM files.
