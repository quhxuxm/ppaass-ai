...
impl UdpDirectionalKeyMaterial {
    pub fn derive(
        ...
        salt_hasher.update(b"ppaass/native-udp/hkdf-salt/v3\0");
        ...
        expand_label(
            &hkdf,
            b"ppaass/native-udp/v3/client-to-server/key",
            &mut material.client_to_server_key,
        )?;
        expand_label(
            &hkdf,
            b"ppaass/native-udp/v3/server-to-client/key",
            &mut material.server_to_client_key,
        )?;
        expand_label(
            &hkdf,
            b"ppaass/native-udp/v3/client-to-server/nonce-prefix",
