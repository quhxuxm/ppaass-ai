...
pub use auth::{
    AuthFailureCode, TCP_AUTH_CONNECT_RESPONSE_OAEP_LABEL, TCP_AUTH_NONCE_LEN,
    TCP_HANDSHAKE_VERSION, TCP_MASTER_SECRET_LEN, TCP_MAX_AUTH_ERROR_LEN, TCP_MAX_RSA_FIELD_LEN,
    TCP_SERVER_NONCE_LEN, TCP_SESSION_ID_LEN, tcp_auth_connect_request_transcript,
