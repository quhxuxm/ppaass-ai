...
const messages: Record<string, string> = {
  ...
  "凭据已由 Proxy Web 托管": "Credentials are managed by Proxy Web",
  ...
  "用户名": "Username", "密码": "Password", "输入 Proxy Web 用户名": "Enter your Proxy Web username",
  ...
  "私钥会从 Proxy Web 自动下载并应用到 Agent，不会显示在界面中。": "The private key is downloaded from Proxy Web and applied to Agent automatically. It is never shown in the interface.",
