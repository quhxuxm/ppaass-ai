...
const messages: Record<string, string> = {
  ...
  "或在系统浏览器中登录": "Or sign in with your system browser",
  "使用浏览器登录": "Sign in with browser",
  "系统浏览器授权": "System browser authorization",
  "在系统浏览器中继续": "Continue in your system browser",
  "等待你在系统浏览器中确认": "Waiting for confirmation in your system browser",
  "认证服务繁忙，已自动放慢检查频率": "The authentication service is busy; checking less frequently",
  "授权成功，正在应用 Agent 凭据": "Authorized; applying Agent credentials",
  "设备授权码": "Device authorization code", "剩余时间": "Time remaining",
  "取消设备登录": "Cancel device sign-in",
  ...
  "当前账户": "Current account", "退出": "Sign out",
