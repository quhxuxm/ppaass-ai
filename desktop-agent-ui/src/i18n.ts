...
const messages: Record<string, string> = {
  ...
  "凭据已由 Proxy Registry 托管": "Credentials are managed by Proxy Registry",
  "登录后自动下载并应用，Agent 不展示或接受手工更改。": "Downloaded and applied automatically after sign-in. Agent neither displays nor accepts manual changes.",
  "TCP 始终走 TCP": "TCP always uses TCP",
  ...
  "当前账户没有使用抓包功能的权限": "This account cannot use packet capture",
  "当前账户没有查看原始配置的权限": "This account cannot view the raw configuration",
  "当前账户没有查看原始配置的权限，无法恢复完整默认配置": "This account cannot view raw configuration, so the full default configuration cannot be restored",
  "当前账户没有出口配置编辑权限。远端出口地址、连接超时、消息压缩格式和 UDP 会话数仅供查看。": "This account cannot edit egress settings. Remote addresses, connection timeout, message compression, and UDP sessions are read-only.",
  "当前账户没有修改系统线程数的权限，线程配置仅供查看。": "This account cannot change runtime threads. The thread setting is read-only.",
  "已重新载入": "Reloaded",
  ...
  "Agent 登录": "Agent sign in", "连接你的代理账户": "Connect your proxy account",
  "登录后才能进入桌面 Agent，并使用为当前账户批准的代理凭据。": "Sign in to enter Desktop Agent and use the proxy credentials approved for your account.",
  "用户名": "Username", "密码": "Password", "输入 Proxy Registry 用户名": "Enter your Proxy Registry username",
  "至少 8 位": "At least 8 characters", "登录并配置 Agent": "Sign in and configure Agent",
  "记住用户名和密码": "Remember username and password",
  "注册和账户管理": "Registration and account management",
  "凭据由本机安全处理": "Credentials are handled securely on this device",
  "私钥会从 Proxy Registry 自动下载并应用到 Agent，不会显示在界面中。": "The private key is downloaded from Proxy Registry and applied to Agent automatically. It is never shown in the interface.",
  "正在检查登录状态": "Checking sign-in status", "准备本机 Agent 配置": "Preparing the local Agent configuration",
  "当前账户": "Current account", "普通用户": "User", "管理员": "Administrator",
  "账户管理": "Account management", "管理用户": "Manage users",
  "生成新密钥": "Generate new key", "退出": "Sign out",
  "新密钥会直接下载并应用到 Agent，私钥不会显示。若 Agent 正在运行，应用后会自动重启。": "The new key is downloaded and applied directly without displaying the private key. A running Agent restarts automatically.",
  "当前密码": "Current password", "输入当前密码": "Enter current password",
  "取消": "Cancel", "确认生成并应用": "Generate and apply",
