use desktop_agent_ui::config::{
    ...
    enforce_managed_identity, load_config_from_path, proxy_registry_url_from_config,
    redact_managed_identity, summarize_config, toggle_tun_enabled_in_config, upsert_toml_bool,
    write_config_file,
};
use desktop_agent_ui::models::LoadedAgentConfig;
use std::fs;
