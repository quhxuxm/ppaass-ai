use crate::{
    AccessBatchRepository, AccessLogRepository, AccessLogSettings, AccessProtocol, AccessRecord,
...
const ACCESS_LOG_SCHEMA_VERSION: i64 = 2;
...
const MAX_ACCESS_BATCH_ID_BYTES: usize = 128;
const MAX_ACCESS_BATCH_RECORDS: usize = 1_000;
...
///
/// It deliberately has no account or key-management implementation, so access-history retention
/// and future database adapters remain separate from account and key persistence.
#[derive(Debug, Clone)]
