...
pub const DEFAULT_YAMUX_SERVER_MAX_STREAMS_PER_SESSION: usize = 1024;
pub const DEFAULT_YAMUX_SERVER_CONNECTION_WRITE_TIMEOUT_SECS: u64 = 30;
pub const DEFAULT_YAMUX_SERVER_STREAM_WINDOW_SIZE_KB: usize = 1024;
