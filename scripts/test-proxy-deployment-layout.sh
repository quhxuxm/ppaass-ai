...
reject_text .github/workflows/deploy-proxy-entry.yml 'AUTH_CONNECT_PRIVATE_KEY'
reject_text .github/workflows/deploy-proxy-entry.yml 'auth-connect-private-key.pem'
...
reject_text deploy/proxy-entry/install.sh 'AuthConnect private key'
reject_text deploy/proxy-entry/install.sh 'auth-connect-private-key.pem'
