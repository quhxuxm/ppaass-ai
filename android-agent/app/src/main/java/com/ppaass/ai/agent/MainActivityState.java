...
protected int COLOR_SURFACE;
protected int COLOR_CONTROL;
protected int COLOR_TEXT;
protected int COLOR_MUTED;
protected int COLOR_BORDER;
protected int COLOR_ACCENT;
protected int COLOR_ACCENT_DARK;
protected int COLOR_ACCENT_SOFT;
protected int COLOR_ACTION_START;
protected int COLOR_ACTION_START_SOFT;
protected int COLOR_ACTION_INFO;
protected int COLOR_ACTION_INFO_SOFT;
protected int COLOR_ACTION_WARN;
protected int COLOR_ACTION_WARN_SOFT;
protected int COLOR_ACTION_STOP;
protected int COLOR_ACTION_STOP_SOFT;
protected int COLOR_STATUS_RUNNING;
protected int COLOR_STATUS_STOPPED;
protected int COLOR_STATUS_STOPPED_SOFT;
...
protected final Runnable statusRefresh = new Runnable() {
    ...
    protected void reloadUiPalette() {
        ...
        COLOR_SURFACE = UiPalette.SURFACE;
        COLOR_CONTROL = UiPalette.CONTROL;
        COLOR_TEXT = UiPalette.TEXT;
        COLOR_MUTED = UiPalette.MUTED;
        COLOR_BORDER = UiPalette.BORDER;
        COLOR_ACCENT = UiPalette.ACCENT;
        COLOR_ACCENT_DARK = UiPalette.ACCENT_STRONG;
        COLOR_ACCENT_SOFT = UiPalette.ACCENT_SOFT;
        COLOR_ACTION_START = UiPalette.ACTION_START;
        COLOR_ACTION_START_SOFT = UiPalette.ACTION_START_SOFT;
        COLOR_ACTION_INFO = UiPalette.ACTION_INFO;
        COLOR_ACTION_INFO_SOFT = UiPalette.ACTION_INFO_SOFT;
        COLOR_ACTION_WARN = UiPalette.ACTION_WARN;
        COLOR_ACTION_WARN_SOFT = UiPalette.ACTION_WARN_SOFT;
        COLOR_ACTION_STOP = UiPalette.ACTION_STOP;
        COLOR_ACTION_STOP_SOFT = UiPalette.ACTION_STOP_SOFT;
        COLOR_STATUS_RUNNING = UiPalette.STATUS_RUNNING;
        COLOR_STATUS_STOPPED = UiPalette.STATUS_STOPPED;
        COLOR_STATUS_STOPPED_SOFT = UiPalette.STATUS_STOPPED_SOFT;
    }
