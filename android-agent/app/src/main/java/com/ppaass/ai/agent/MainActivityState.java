...
protected static final int COLOR_BACKGROUND = Color.rgb(248, 251, 250);
protected static final int COLOR_SURFACE = Color.WHITE;
protected static final int COLOR_CONTROL = Color.rgb(241, 245, 249);
protected static final int COLOR_TEXT = Color.rgb(17, 24, 39);
protected static final int COLOR_MUTED = Color.rgb(100, 116, 139);
protected static final int COLOR_BORDER = Color.rgb(226, 232, 240);
protected static final int COLOR_ACCENT = Color.rgb(45, 170, 158);
protected static final int COLOR_ACCENT_DARK = Color.rgb(18, 128, 119);
protected static final int COLOR_ACCENT_SOFT = Color.rgb(207, 244, 237);
protected static final int COLOR_ACTION_START = Color.rgb(60, 187, 132);
protected static final int COLOR_ACTION_START_SOFT = Color.rgb(211, 247, 228);
protected static final int COLOR_ACTION_INFO = Color.rgb(126, 105, 203);
protected static final int COLOR_ACTION_INFO_SOFT = Color.rgb(236, 232, 255);
protected static final int COLOR_ACTION_WARN = Color.rgb(202, 139, 42);
protected static final int COLOR_ACTION_WARN_SOFT = Color.rgb(255, 239, 204);
protected static final int COLOR_ACTION_STOP = Color.rgb(214, 104, 86);
protected static final int COLOR_ACTION_STOP_SOFT = Color.rgb(255, 225, 218);
protected static final int COLOR_STATUS_RUNNING = Color.rgb(60, 187, 132);
protected static final int COLOR_STATUS_STOPPED = Color.rgb(100, 116, 139);
protected static final int COLOR_STATUS_STOPPED_SOFT = Color.rgb(238, 243, 248);
