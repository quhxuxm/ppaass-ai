...
protected static final int COLOR_BACKGROUND = Color.WHITE;
protected static final int COLOR_SURFACE = Color.argb(224, 255, 255, 255);
protected static final int COLOR_CONTROL = Color.argb(176, 255, 255, 255);
protected static final int COLOR_TEXT = Color.rgb(35, 41, 53);
protected static final int COLOR_MUTED = Color.rgb(105, 113, 130);
protected static final int COLOR_BORDER = Color.rgb(225, 223, 218);
protected static final int COLOR_ACCENT = Color.rgb(0, 169, 120);
protected static final int COLOR_ACCENT_DARK = Color.rgb(21, 94, 232);
protected static final int COLOR_ACCENT_SOFT = Color.rgb(188, 243, 221);
protected static final int COLOR_ACTION_START = Color.rgb(229, 22, 112);
protected static final int COLOR_ACTION_START_SOFT = Color.rgb(255, 236, 246);
protected static final int COLOR_ACTION_INFO = Color.rgb(21, 94, 232);
protected static final int COLOR_ACTION_INFO_SOFT = Color.rgb(210, 224, 255);
protected static final int COLOR_ACTION_WARN = Color.rgb(242, 193, 0);
protected static final int COLOR_ACTION_WARN_SOFT = Color.rgb(255, 223, 114);
...
protected static final int COLOR_STATUS_RUNNING = Color.rgb(0, 169, 120);
