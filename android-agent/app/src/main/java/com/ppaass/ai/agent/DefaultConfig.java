...
final class DefaultConfig {
    ...
    static final int UDP_YAMUX_MAX_STREAMS_PER_SESSION = 32;
    ...
    static final int TCP_YAMUX_STREAM_WINDOW_SIZE_KB = 512;
    static final int UDP_YAMUX_STREAM_WINDOW_SIZE_KB = 512;
